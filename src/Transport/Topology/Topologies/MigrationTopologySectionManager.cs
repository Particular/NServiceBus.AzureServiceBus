namespace NServiceBus.Transport.AzureServiceBus
{
    ...
    class MigrationTopologySectionManager : ITopologySectionManagerInternal
    {
        public MigrationTopologySectionManager(string defaultNameSpaceAlias, NamespaceConfigurations namespaceConfigurations, string originalEndpointName, PublishersConfiguration publishersConfiguration, INamespacePartitioningStrategy namespacePartitioningStrategy, AddressingLogic addressingLogic)
        {
