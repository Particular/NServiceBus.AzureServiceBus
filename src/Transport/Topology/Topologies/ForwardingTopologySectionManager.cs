namespace NServiceBus.Transport.AzureServiceBus
{
    ...
    class ForwardingTopologySectionManager : ITopologySectionManagerInternal
    {
        ...
        public TopologySectionInternal DeterminePublishDestination(Type eventType, string localAddress) => namespacePartitioningStrategy.SendingNamespacesCanBeCached ? publishDestinations.GetOrAdd(eventType, t => CreateSectionForPublish()) : CreateSectionForPublish();
