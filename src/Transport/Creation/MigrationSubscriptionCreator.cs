namespace NServiceBus.Transport.AzureServiceBus
{
    ...
    class MigrationSubscriptionCreator : ICreateAzureServiceBusSubscriptionsInternal
    {
        ...
        public MigrationSubscriptionCreator(AzureServiceBusForwardingSubscriptionCreator fowardingCreator, AzureServiceBusSubscriptionCreatorV6 v6CompatibleCreator)
        {
