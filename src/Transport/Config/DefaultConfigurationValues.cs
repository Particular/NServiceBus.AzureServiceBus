namespace NServiceBus
{
    ...
    public class DefaultConfigurationValues
    {
        ...
        void ApplyDefaultValuesForQueueDescriptions(SettingsHolder settings)
        {
            ...
            settings.SetDefault(WellKnownConfigurationKeys.Topology.Resources.Queues.RequiresSession, true);
            settings.SetDefault(WellKnownConfigurationKeys.Topology.Resources.Queues.EnablePartitioning, false);
            settings.SetDefault(WellKnownConfigurationKeys.Topology.Resources.Queues.SupportOrdering, true);
            ...
            settings.SetDefault(WellKnownConfigurationKeys.Topology.Resources.Queues.ForwardDeadLetteredMessagesTo, "");
            settings.SetDefault(WellKnownConfigurationKeys.Topology.Resources.Queues.ForwardTo, "");
            settings.SetDefault(WellKnownConfigurationKeys.Topology.Resources.Queues.IsAnonymousAccessible, false);
        }
    }
}