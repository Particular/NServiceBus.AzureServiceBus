namespace NServiceBus.AzureServiceBus.Addressing
{
    ...
    public class EndpointOrientedTopologySanitizationForTopics : SanitizationStrategy
    {
        ...
        public EndpointOrientedTopologySanitizationForTopics(ReadOnlySettings settings)
        {
        ...
        public override string Sanitize(string entityPath)
        {
            ...
            var shouldHash = entityPath.Length > settings.GetOrDefault<int>(WellKnownConfigurationKeys.Topology.Addressing.Sanitization.TopicPathMaximumLength);
            if (shouldHash)
            {
