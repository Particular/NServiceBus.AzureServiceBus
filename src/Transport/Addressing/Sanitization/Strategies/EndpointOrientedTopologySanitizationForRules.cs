namespace NServiceBus.AzureServiceBus.Addressing
{
    ...
    public class EndpointOrientedTopologySanitizationForRules : SanitizationStrategy
    {
        ...
        public EndpointOrientedTopologySanitizationForRules(ReadOnlySettings settings)
        {
        ...
        public override string Sanitize(string entityPath)
        {
            ...
            var shouldHash = entityPath.Length > settings.GetOrDefault<int>(WellKnownConfigurationKeys.Topology.Addressing.Sanitization.RuleNameMaximumLength);
            if (shouldHash)
            {
