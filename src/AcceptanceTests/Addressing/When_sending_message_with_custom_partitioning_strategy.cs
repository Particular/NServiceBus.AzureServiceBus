namespace NServiceBus.Azure.Transports.WindowsAzureServiceBus.AcceptanceTests.Addressing
{
    ...
    public class When_sending_message_with_custom_partitioning_strategy : NServiceBusAcceptanceTest
    {
        ...
        {
            var namespaceManager1 = NamespaceManager.CreateFromConnectionString(targetConnectionString);
            await namespaceManager1.DeleteQueueAsync(Conventions.EndpointNamingConvention(typeof(TargetEndpoint)));
            ...
            await namespaceManager2.DeleteQueueAsync(Conventions.EndpointNamingConvention(typeof(TargetEndpoint)));
