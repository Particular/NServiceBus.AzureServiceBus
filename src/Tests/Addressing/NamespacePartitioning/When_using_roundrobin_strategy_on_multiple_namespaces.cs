namespace NServiceBus.Azure.WindowsAzureServiceBus.Tests.Addressing.NamespacePartitioning
{
    ...
    public class When_using_roundrobin_strategy_on_multiple_namespaces
    {
        ...
        public void SetUp()
        {
            ...
            extensions.AddPartitioningNamespace(PrimaryName, PrimaryConnectionString);
            extensions.AddPartitioningNamespace(SecondaryName, SecondaryConnectionString);
            extensions.AddPartitioningNamespace(TertiaryName, TertiaryConnectionString);
