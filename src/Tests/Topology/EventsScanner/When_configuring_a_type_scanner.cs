namespace NServiceBus.Azure.WindowsAzureServiceBus.Tests.Topology.EventsScanner
{
    ...
    public class When_configuring_a_type_scanner
    {
        [Test]
        public void Two_scanners_should_be_equal_if_they_reference_the_same_type()
        {
            var scanner1 = new TypeEventsScanner(typeof(MyType1));
            var scanner2 = new TypeEventsScanner(typeof(MyType1));
        ...
        {
            var scanner1 = new TypeEventsScanner(typeof(MyType1));
            var scanner2 = new TypeEventsScanner(typeof(MyType2));
